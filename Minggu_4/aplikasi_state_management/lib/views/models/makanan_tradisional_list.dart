...
import 'package:aplikasi_state_management/views/models/detail_makanan_tradisional.dart';
import 'package:aplikasi_state_management/views/models/list_item.dart';


class MakananTradisionalList extends StatefulWidget {
  final List<MakananTradisional> doneMakananTradisionalList;

  const MakananTradisionalList({
    Key? key,
    required this.doneMakananTradisionalList,
  }) : super(key: key);
  @override
  // ignore: library_private_types_in_public_api, no_logic_in_create_state
  _MakananTradisionalListState createState() => _MakananTradisionalListState(doneMakananTradisionalList);
}

class _MakananTradisionalListState extends State<MakananTradisionalList> {
  final List<MakananTradisional> doneMakananTradisionalList;
  ...
  _MakananTradisionalListState(this.doneMakananTradisionalList);
        ...
        return InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) {
              return DetailMakananTradisional(place: place);
            }));
          },
          child: ListItem(
            place: place,
            isDone: doneMakananTradisionalList.contains(place),
            onCheckBoxClicked: (bool? value) {
              setState(() {
                if (value == true) {
                  doneMakananTradisionalList.add(place);
                } else {
                  doneMakananTradisionalList.remove(place);
                }
              });
            },
          ),
